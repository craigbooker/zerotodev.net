...
As an aspiring programmer, it is important to have a proper understanding of the different areas of software development. Those already in the industry will consider this knowledge as a given, but for those entering into life as a developer these are largely unknown. There are numerous areas of software development and I will not pretend to cover all of them. What I hope to do is to cover some of the more common areas. Often when trying to understand something foreign, sometimes it is helpful to think of the various aspects of a software product or service by examining one you already are familiar with.
